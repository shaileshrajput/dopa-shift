...
- [x] 1. Establish the design-system layer in the `ui` module
  - [x] 1.1 Implement `DopaShiftTokens`
  ...
  - [x] 1.2 Implement `DopaShiftTypography` and `DopaShiftShapes`
  ...
  - [x] 1.3 Implement `DopaShiftTheme`
  ...
  - [x] 1.4 Write design-conformance tests
...
- [x] 2. Implement reusable Kinetic components
  - [x] 2.1 Implement `CompletionRing`, `MomentumCheckbox`, and `KineticCard`
  ...
  - [x] 2.2 Implement `SegmentedPill`, `KineticChip`, `UsageBar`, and `QuickCreateFab`
  ...
  - [x] 2.3 Write pure derivation helpers for state→render rules
  ...
  - [x] 2.4 Write property test for continue-button cooldown gating
  ...
  - [x] 2.5 Write property test for daily-bar color mapping
  ...
  - [x] 2.6 Write property test for roadmap fraction and integer percent
  ...
  - [x] 2.7 Write property test for completed-item styling
  ...
  - [x] 2.8 Write accessibility property test for touch targets
...
- [x] 3. Checkpoint - Ensure design-system and component tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Define UI-state contracts (`ui` module, presentation view models)
  - [x] 4.1 Add screen UI-state and row types
...
- [x] 5. Implement the Home Dashboard screen (AUI-1)
  - [x] 5.1 Implement `DashboardScreen`
  ...
  - [x] 5.2 Write Compose UI and instrumented tests for the Dashboard
...
- [ ] 6. Implement the Intercept Overlay screen (AUI-2)
  - [x] 6.1 Implement `InterceptOverlayScreen`
...
- [x] 7. Implement the App Limits & Rules screen (AUI-3)
  - [x] 7.1 Implement `AppLimitsScreen`
  ...
  - [x] 7.2 Write Compose UI test for App Limits
...
- [x] 8. Implement the Goals & Habits and Goal Detail screens (AUI-4, AUI-5)
  - [x] 8.1 Implement `GoalsHabitsScreen`
  ...
  - [x] 8.2 Implement `GoalDetailScreen`
  ...
  - [x] 8.3 Write Compose UI and instrumented tests for Goals and Detail
...
- [ ] 9. Implement the Analytics & Efficiency screen (AUI-6)
  - [x] 9.1 Implement `AnalyticsScreen`
...
- [ ] 10. Implement the Settings & Profile screen and Global Navigation (AUI-7)
  - [x] 10.1 Implement `SettingsScreen`
  ...
  - [x] 10.2 Implement `DopaShiftBottomNavBar`
  ...
  - [x] 10.3 Write Compose UI and instrumented tests for Settings and nav
...
- [x] 11. Wire navigation and overlay entry in the `app` module
  - [x] 11.1 Wire the `NavHost` and bottom-nav destinations
  ...
  - [x] 11.2 Wire the overlay composable to the interception service
...
- [x] 12. Localization and accessibility conformance
  - [x] 12.1 Externalize all UI strings to `en`, `hi`, `mr` resources
  ...
  - [x] 12.2 Add content descriptions and run the accessibility scan
...
- [x] 13. Configure the CI gate for the spec test suites
  - [x] 13.1 Register all suites in CI and enforce the gate
