...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class ComposeUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        private final ComposeUiTextLibraryAccessors laccForComposeUiTextLibraryAccessors = new ComposeUiTextLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>compose.ui.text</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ComposeUiTextLibraryAccessors getText() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForComposeUiTextLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ComposeUiTextLibraryAccessors extends SubDependencyFactory {
        private final ComposeUiTextGoogleLibraryAccessors laccForComposeUiTextGoogleLibraryAccessors = new ComposeUiTextGoogleLibraryAccessors(owner);

        public ComposeUiTextLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>compose.ui.text.google</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ComposeUiTextGoogleLibraryAccessors getGoogle() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForComposeUiTextGoogleLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ComposeUiTextGoogleLibraryAccessors extends SubDependencyFactory {

        public ComposeUiTextGoogleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getFonts() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("compose.ui.text.google.fonts");
        }
